    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Payment Gateway "{{ $payment->name ?? '' }}"</h5>
                ...
                <form method="POST" action="{{ route('admin.payments.update', $payment->id) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                            value="{{ old('name', $payment->name) }}" name="name" id="" placeholder="">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        @if ($payment->image)
                            <img src="{{ asset('admin/images/payment/' . $payment->image) }}" width="100"
