                ...
                @if ($category->parent)
                    @if ($category->parent->parent)
                        <li class="breadcrumb-main-item" aria-current="page">
                            <a href="{{ route('product.category', $category->parent->parent->slug) }}">
                                {{ $category->parent->parent->name ?? 'Category' }}</a>
                        </li>
                    @endif
                    <li class="breadcrumb-main-item active" aria-current="page">
                        <a href="{{ route('product.category', $category->parent->slug) }}">
                            {{ $category->parent->name ?? 'Category' }}</a>
                    </li>
                @endif
                <li class="breadcrumb-main-item active" aria-current="page">
